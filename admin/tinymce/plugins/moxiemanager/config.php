<?php
	// General
	$moxieManagerConfig['general.license'] = 'EPHX-PROD-DST1-BLGQ-IXJC-BMDK-KOHA-EV3V';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "rodrigo@legioncreativa.com", "password" => "Javierjavier1990", "groups" => array("administrator"))
	);
